        ...
        <FramerWrapper id="projects">
            <AccordionProvider allowMultiple={false}>
              ...
              <AccordionItemIdProvider id="project2">
                ...
                <AccordionPanel>
                  <div className="flex flex-col gap-6 sticky">
                      <img  src="/src/assets/career-dashboard-home.png" className="screenshots"/>
                      <img  src="/src/assets/career-dashboard-analytics.png" className="screenshots"/>
                  </div>
              ...
              <AccordionItemIdProvider id="project3">
                ...
                <AccordionPanel>
                  <div className="flex flex-col gap-6 sticky">
                      <img src="src/assets/film-box-hero.png" className="screenshots"/>
                      <img src="src/assets/film-box-search.png" className="screenshots"/>
                  </div>
